...
//        return line2;
        ...
        try{
            ...
            Log.d("NAME VALUE PARS",nameValuePairs.toString());
...
//            nameValuePairs.add(new BasicNameValuePair("device_duid", "986409987"));
            ...
            //add data
            UrlEncodedFormEntity v=new UrlEncodedFormEntity(nameValuePairs);
            Log.d("URLEncodedUtils",v.toString());
